...
import { checkRoadmapPassword, type GateState } from './actions';

const initialState: GateState = {};

const RoadmapGateForm: FC = () => {
  const [state, formAction, isPending] = useActionState(checkRoadmapPassword, initialState);
...
export default RoadmapGateForm;
