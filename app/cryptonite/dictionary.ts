...
export const DICTIONARY: Record<Lang, Dictionary> = {
  es: {
    ...
    marketFrei: 'XCN/BTC en FreiExchange',
  ...
  en: {
    ...
    marketFrei: 'XCN/BTC on FreiExchange',
  ...
  ru: {
    ...
    marketFrei: 'XCN/BTC на FreiExchange',
  ...
  de: {
    ...
    marketFrei: 'XCN/BTC auf FreiExchange',
  ...
  zh: {
    ...
    marketsEyebrow: '交易市场',
    marketFrei: 'FreiExchange 上的 XCN/BTC',
