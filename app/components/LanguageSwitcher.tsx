  ...
  return (
    <div className="relative" ref={dropdownRef} style={{ zIndex: 10000 }}>
      <button
        ...
        className="group relative flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-black/60 to-black/40 backdrop-blur-md border border-orange-500/40 hover:border-orange-400 hover:bg-gradient-to-r hover:from-orange-500/30 hover:to-yellow-500/20 transition-all duration-300 text-white hover:text-orange-100 cursor-pointer shadow-lg hover:shadow-orange-500/40 hover:shadow-xl transform hover:scale-105 active:scale-95"
      >
        ...
        <span className="text-sm font-semibold relative z-10 tracking-wide group-hover:text-orange-50 transition-colors duration-200">
          {currentLanguage.name}
        </span>
        
        <svg 
          className={`w-4 h-4 relative z-10 transition-all duration-300 group-hover:text-orange-200 ${
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-3 w-56 bg-black/95 backdrop-blur-xl border border-orange-500/30 rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="py-2">
            {languages.map((language, index) => (
              <button
                ...
                className={`group/language w-full flex items-center gap-4 px-4 py-3.5 text-left transition-all duration-200 hover:bg-gradient-to-r hover:from-orange-500/25 hover:to-yellow-500/15 relative ${
              ...
              >
                ...
                <span className="font-medium text-sm tracking-wide group-hover/language:text-orange-100 transition-colors duration-200">
                  {language.name}
                </span>
